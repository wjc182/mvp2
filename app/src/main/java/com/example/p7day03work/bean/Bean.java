package com.example.p7day03work.bean;
...
public class Bean {
    ...
    public Bean(Integer ret, List<DataDTO> data) {
        this.ret = ret;
        this.data = data;
    }
    ...
    public static class DataDTO {
        ...
        public DataDTO(String id, String title, String pic, String collectNum, String foodStr, Integer num) {
            this.id = id;
            this.title = title;
            this.pic = pic;
